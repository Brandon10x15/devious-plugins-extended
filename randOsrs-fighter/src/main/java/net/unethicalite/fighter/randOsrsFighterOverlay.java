...
public class randOsrsFighterOverlay extends Overlay
{
	private final Client client;
	private final randOsrsFighterPlugin plugin;
	private final randOsrsFighterConfig config;

	@Inject
	private randOsrsFighterOverlay(Client client, randOsrsFighterPlugin plugin, randOsrsFighterConfig config)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
